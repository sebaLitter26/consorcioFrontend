 ...
 */
@Injectable()
export class LegajoDetailResolver implements Resolve<Empleado | null> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<Empleado> | null {
        ...
        return (Object.keys(route.queryParams).length === 0) ? null : this.recursosService.getEmpleadoByLegajo(route.queryParams.psicotecnico.legajo);
    }
}